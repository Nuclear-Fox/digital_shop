...
contracts = compile_files(['contract/MyToken.sol'])
# separate main file and link file
main_contract = contracts.pop("contract/MyToken.sol:MyToken")
erc20_contract = contracts.pop("stringUtils.sol:StringUtils")
